  ...
  return (
    <div className='h-full overflow-y-scroll p-6 items-start flex flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <p className='text-xs text-gray-500 font-light mt-1'>Supports PNG, JPEG, JPG and other Image Formats</p>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 '>
...

       {
        !content ? (<div className='flex-1 flex justify-center items-center' >
          ...
          <div>
            <img src={content} alt="image" className='w-full h-full mt-3 object-contain' />
          </div>
        )
       }
